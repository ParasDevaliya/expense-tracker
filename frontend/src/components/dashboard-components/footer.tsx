      ...
      <div className="navbar">
        <div className="flex justify-between items-center w-full">
          <div>
            <Link
              to="/dashboard"
              className="flex flex-col justify-items-center items-center hover:bg-base-300 p-2 rounded-sm"
            >
              {" "}
              <svg
                viewBox="0 0 24 24"
              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  {" "}
                  <rect width="24" height="24" fill="none" className=""></rect>{" "}
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
          ...
          <div>
            ...
            >
              ...
              <small className="text-white">Friends</small>
            </Link>
          </div>
          <div>
            <Link
            ...
            >
              ...
              <small className="text-white">Activity</small>
            </Link>
          </div>
          <div>
            <Link
